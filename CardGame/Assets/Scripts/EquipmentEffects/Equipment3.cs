...
public class Equipment3 : MonoBehaviour, IPointerClickHandler
{
    ...
    public void ToMonster(GameObject monster)
    {
        ...
        if (BattleField.Instance.usingEquipment != null)
        {
            ...
            {
                ThisMonster thismonster=monster.GetComponent<ThisMonster>();
                thismonster.isAbsorbBoom = false;
                Skills.Instance.AddAbsorbCount(1, thismonster);
