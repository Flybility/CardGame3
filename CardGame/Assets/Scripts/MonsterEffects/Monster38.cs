...
public class Monster38 : MonoBehaviour
{
    ...
    {
        if (BattleField.Instance.isFinished == false && monster.isSwallowed == false) Skills.Instance.StartLightingInterval(monster, boomDamage);
    }
