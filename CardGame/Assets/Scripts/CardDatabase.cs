...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(26, "缄默幽灵",   25, 20, 35,  1, "每回合生成30护甲并顺时针与邻位的心魔互换。",                                                                                             Resources.Load<Sprite>("CardImages/26"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
