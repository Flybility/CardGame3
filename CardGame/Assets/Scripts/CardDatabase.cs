...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(17, "黑夜",       25,  8,  5,  1, "每回合攻击时施加2层恐惧。",                                                                                                      Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        ...
        monsterCardList.Add(new MonsterCard(21, "蜘蛛",       33,  8,  5,  1, "每回合攻击时施加1层束缚(下回合抽牌数-1)",                                                                                        Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        ...
        monsterCardList.Add(new MonsterCard(30, "分赃",       50, 20, 35,  1, "击杀后在场的所有心魔恢复15点血量",                                                                                                       Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(31, "挣扎",       40, 30, 40,  1, "击杀时仍会对玩家立即造成最后一次伤害",                                                                                                   Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(32, "孵化者",    160, 33, 70,  1, "每回合攻击后在战场任意一空位置召唤一只孪生恶魔",                                                                                             Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(33, "孪生恶魔",   10,  4,  0,  1, "攻击力=4+场上心魔数",                                                        Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        ...
        monsterCardList.Add(new MonsterCard(36, "焦虑",       20,  8,  2,  1, "击杀后对相邻的怪物添加两层灼伤",                                                                                                         Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(37, "使者",        6,  1,  2,  1, "每次进行换位时添加1张牌到手牌" + "\n" + "攻击力随回合数增加",                                                                    Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"), false));
        ...
        monsterCardList.Add(new MonsterCard(42, "暴戾魔株",   40, 15, 20,  1, "移动时在其原来位置留下1枚同化种子。具有植物性。",                                                                                        Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"), false));
    }                                                                      
