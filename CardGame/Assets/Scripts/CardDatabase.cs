...
public class CardDatabase : MonoSingleton<CardDatabase>
{
    ...
    private void Awake()
    {
        ...
        monsterCardList.Add(new MonsterCard(11, "无奈",        8,  4,  2,  2, "击杀后下回合从抽牌堆中多抽取2张牌",                                                                                                      Resources.Load<Sprite>("CardImages/11"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(12, "痛苦",        8,  4,  2,  2, "击杀后下回合常规攻击+15",                                                                                                                Resources.Load<Sprite>("CardImages/12"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        monsterCardList.Add(new MonsterCard(13, "折磨",        8,  4,  2,  2, "存在场上时情绪每回合不再下降",                                                                                                           Resources.Load<Sprite>("CardImages/13"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        ...
        monsterCardList.Add(new MonsterCard(23, "怜悯",       50, 20, 45,  1, "每回合为邻位的心魔恢复血量各10点",                                                                                                       Resources.Load<Sprite>("CardImages/02"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));                                                              
        ...
        monsterCardList.Add(new MonsterCard(31, "掮客",       12,  6,  5,  1, "存活时下回合抽牌数等于场上空位数",                                                                                                       Resources.Load<Sprite>("CardImages/37"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
        ...
        monsterCardList.Add(new MonsterCard(33, "孪生恶魔",   10,  4,  2,  1, "攻击力=4+场上心魔数",                                                                                                                    Resources.Load<Sprite>("CardImages/33"), Resources.Load<Sprite>("CardBackgrounds/2"),  false));
